...
public partial class Maze : Node3D
{
	...
	[Export] public int SpikeClusterCount = 3;
	[Export(PropertyHint.Range, "0,1,0.05")] public float SpikeClusterChance = 0.6f;
	[Export] public int SpikeClusterSize = 3; // cantidad de celdas en fila (a lo largo del pasillo)
	[Export] public int ArrowClusterCount = 5;
	[Export] public int ArrowClusterSize = 3;
	[Export] public int CageTrapCount = 3;
